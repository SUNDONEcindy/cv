...
### Staff Site Reliability Engineer (SRE) for the Jenkins Project at CloudBees
...
icon:users[] link:https://github.com/open-io[OpenIO,window="_blank"] / link:https://www.ovh.com[OVHcloud,window="_blank"] (link:https://blocksandfiles.com/2020/07/24/ovhcloud-acquires-openio-to-build-best-object-storage-service/[OVHcloud acquired OpenIO in July 2020])- Remote
...
** User experience, documentation, website and packaging for https://traefik.io/traefik-mesh/[Maesh Service Mesh]
====
...
* icon:calendar[] `12/2024` (Promotion M2 IW - 2024/2025)
** link:https://dduportal.github.io/esgi-courses/2024-S1-M2-IW[icon:slideshare[] Slides,window="_blank"]

* icon:calendar[] `01/2024` (Promotion M1 ALT - 2023/2024)
** link:https://dduportal.github.io/esgi-courses/2023-S1-M1-AL-ALT[icon:slideshare[] Slides,window="_blank"]

* icon:calendar[] `09/2023` (Promotion M2 IW - 2023/2024)
** link:https://dduportal.github.io/esgi-courses/2023-S1-M2-IW[icon:slideshare[] Slides,window="_blank"]

* icon:calendar[] `02/2023` (Promotion M1 ALT - 2022/2023)
** link:https://dduportal.github.io/esgi-courses/2022-2023[icon:slideshare[] Slides,window="_blank"]

* icon:users[] link:https://www.esgi.fr/[École Supérieure de Génie Informatique (E.S.G.I.) - Lyon,window="_blank"]

[NOTE]
.Description
====
A 3-days introduction to Continuous Integration and Delivery (C.I/C.D.) practices to IT Master-1 and Master-2 students.
Uses GitHub Actions, Docker and NodeJS for included workshop.
====


### Course: Introduction to Continuous Integration and Deployment

* icon:calendar[] `03/2023` (Promotion 2022/2023)
** link:https://dduportal.github.io/ensg-ci-cd/2018-2019/#/introduction_au_ci_cd[icon:slideshare[] Slides,window="_blank"]

* icon:calendar[] `12/2021` (Promotion 2021/2022)
** link:https://cicd-lectures.github.io/slides/2021/#/[icon:slideshare[] Slides,window="_blank"]

* icon:calendar[] `12/2020` (Promotion 2020/2021)
** link:https://cicd-lectures.github.io/slides/2020/#/[icon:slideshare[] Slides,window="_blank"]
...
* image:fr.png[width=15] WaJUG `Jenkins & Blue Ocean Workshop` - Liège - 2018
